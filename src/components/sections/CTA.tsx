      ...
      <div className="container-page relative">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <a href={`tel:${CONTACT.phoneTel}`} className="btn-ghost text-base px-8 py-4">
...
function ContactCard({ icon: Icon, label, value, href, external }: ContactCardProps) {
  const content = (
    <>
      <div className="flex h-11 w-11 items-center justify-center rounded-md bg-gold/10 border border-gold/20 text-gold mb-4">
  ...
  const baseClass =
    "card-tech group p-6 text-left transition-all";
